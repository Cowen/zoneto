    ...
    df = pl.DataFrame(
        {
            ...
            "proposed_use_category": ["residential", "mixed_use"],
            "postal_fsa": ["M5V", "M4K"],
    ...
    df = pl.DataFrame(
        {
            ...
            "proposed_use_category": ["residential", "mixed_use", None],
